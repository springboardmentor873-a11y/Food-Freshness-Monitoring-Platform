  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Notifications and Alerts</h1>
        ...
        <div className="p-2">
          {filtered.length === 0 ? (
            <EmptyState
              ...
              description="No active alerts or system notifications for your account right now."
